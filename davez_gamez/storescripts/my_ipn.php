...
if ($fullAmount != $grossAmount) {
        ...
        mail("quinnd6@msn.com", "Price Jack or Bad Programming", $message, "From: quinnd6@msn.com" );
        exit(); // exit script
} 
...
mail("quinnd6@msn.com", "NORMAL IPN RESULT YAY MONEY!", $req, "From: quinnd6@msn.com");
?>